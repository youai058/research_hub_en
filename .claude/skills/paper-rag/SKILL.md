...
- **Store**: `chromadb.PersistentClient(path="papers/rag/chroma")`, collection=`"papers"`
...
[
  {
    "id": "attack-lldm_3_1",
    "score": 0.87,
    "source": "papers/ICLR/2026/attack-lldm.md",
    "section": "Methodology",
...
```json
{
  ...
  "files": {
    "papers/ICLR/2026/attack-lldm.md": {
      "sha256": "abc123...",
      "mtime": 1234567890,
      "chunks": 12,
...
- ChromaDB 손상: `papers/rag/chroma/` 백업 후 전체 reindex (`index.py --rebuild`)
