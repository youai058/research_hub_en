...
- **When to apply**: across CLAUDE.md §2/§4.5, `orchestrate/SKILL.md`, experiment-plan/design/impl skills, experiment-planner agent, `protect_external_paths.sh`, `docs/harness-layout.md` — 9 files total — all `>30분|>=30|30min|1800s` tokens have been removed. Do NOT reintroduce. Paid / external-modification sub-phases still require Phase B re-approval before E-1/F-1.
